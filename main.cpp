...
/*    id_sun = LoadBitmap("C://Dakie//NUM's Lessons//3rd course Autumn//Computer Graphs//SolarSystemBmp//sun1.bmp");
    ...
    id_mars = LoadBitmap("C://Dakie//NUM's Lessons//3rd course Autumn//Computer Graphs//SolarSystemBmp//mars1.bmp");
    id_jupiter = LoadBitmap("C://Dakie//NUM's Lessons//3rd course Autumn//Computer Graphs//SolarSystemBmp//jupiter1.bmp");
    id_saturn = LoadBitmap("C://Dakie//NUM's Lessons//3rd course Autumn//Computer Graphs//SolarSystemBmp//saturn1.bmp");
    id_uranus = LoadBitmap("C://Dakie//NUM's Lessons//3rd course Autumn//Computer Graphs//SolarSystemBmp//uranus1.bmp");
